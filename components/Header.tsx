...
export default function Header() {
  ...
  return (
    <header className="bg-white/60 backdrop-blur-lg border-b border-slate-100 shadow-[0_4px_30px_rgba(0,0,0,0.03)] sticky top-0 z-50 transition-all">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-14 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <Link
            ...
            className="bg-slate-900 text-white px-4 py-1.5 rounded-lg font-medium text-sm hover:bg-slate-800 transition-all shadow-sm"
          >
            Dùng thử Demo
          </Link>
        </div>
